//
//  FilteredFeedViewController.swift
//  Homework Helper
//
...
class FilteredFeedViewController: UIViewController {
    ...
    @IBAction func goToMyPosts(_ sender: UIButton) {
        let myPosts = self.storyboard?.instantiateViewController(withIdentifier: "myPosts")as?FeedViewController
        self.present(myPosts!, animated: false)
    }
